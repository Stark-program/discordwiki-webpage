    ...
    <div className="flex flex-col items-center justify-center w-screen h-screen ">
      <div className="z-40 h-2/3 lg:h-1/2">
        ...
        <div className="flex justify-center mt-12 lg:mt-24">
          <Link href="/guilds">
            <button className="px-4 py-2 font-bold text-gray-800 border border-gray-400 rounded shadow font-Baskerville bg-DW-white hover:bg-gray-100 transition ease-in-out delay-25">
